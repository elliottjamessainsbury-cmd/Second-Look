(function (root, factory) {
  ...
  function buildSeedProfile({ questionnaireAnswers, seedFilms, externalSeed, userProfile, profileFilms, dislikedFilms }) {
    ...
    if (externalSeed) {
      allPositiveSignalFilms.push(externalSeed);
    }
    ...
    allPositiveSignalFilms.forEach((seed) => {
      ...
      const weight = explicitSeeds.includes(seed) || seed === externalSeed ? 1.2 : 0.8;
